 ...
 * Plugin URI:        https://keepthescore.co/wordpress-leaderboard/
...
function keepthescore_shortcode( $atts = []) {
    ...
    if ($token == 'error') {
        ...
        <a href='https://keepthescore.com/wordpress-leaderboard/'> See here for more information. </a>
         </span>";

    } else {
        // Create embed code
        $o .='<iframe id="iframe-' .$token.'" src="https://keepthescore.com/wordpress/' .$token. '/"
        style="width:100%;border:none;"></iframe><script>window.onmessage = (e) =>
