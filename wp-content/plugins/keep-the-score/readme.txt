...
To start the process, [create a scoreboard or leaderboard by clicking here](https://keepthescore.com/choose2/). Note that you require a paid [PRO plan](https://keepthescore.com/pricing/) to use this feature.
...
2. Create a leaderboard on [Keepthescore.com](https://keepthescore.com/choose2/) and get its **shortcode**.
...
You can write us an email here: [wordpress@keepthescore.co](mailto:wordpress@keepthescore.co)
...
1. [Create a scoreboard or leaderboard by clicking here](https://keepthescore.com/choose2/).
2. Click on "Share" button at the top of your newly created leaderboard or scoreboard.
3. Click on the "Embed on WordPress site" button.
